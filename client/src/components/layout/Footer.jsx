        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {shopLinks.map((link) => (
                <li key={link.label}>
                  <Link to={link.to} className="text-surface-400 hover:text-primary-400 transition-colors no-underline text-sm inline-flex items-center gap-1.5 group">
          ...
          <div>
            ...
            <div className="mt-5 p-3 bg-surface-800/50 rounded-xl border border-surface-800">
              <p className="text-xs text-surface-400 leading-relaxed">
                🔒 Secure SSL encryption<br />
                🚚 Free shipping over PKR 5,000<br />
