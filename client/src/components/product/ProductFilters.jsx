...
const ProductFilters = ({ filters, onFilterChange }) => {
  return (
    <div className="bg-white rounded-2xl border border-surface-200 p-5 space-y-5">
      {/* Search */}
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 border border-surface-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
        />
      </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-sm font-semibold text-surface-700">Category</h3>
        </div>
      ...
      <div>
        ...
        <div className="flex gap-3">
          <input
            ...
            className="w-full px-3 py-2 border border-surface-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
          />
          <input
            type="number"
            placeholder="Max"
