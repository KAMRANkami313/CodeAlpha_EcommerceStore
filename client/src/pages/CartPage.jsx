...
const CartPage = () => {
  ...
  if (!isAuthenticated) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        <ShoppingBag className="w-16 h-16 mx-auto text-surface-300 dark:text-surface-600 mb-4" />
        <h2 className="text-2xl font-bold text-surface-800 dark:text-white mb-2">Your cart is waiting</h2>
        <p className="text-surface-500 dark:text-surface-400 mb-6">Login to view your cart and start shopping</p>
  ...
  if (cart.items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-surface-500 dark:text-surface-400 mb-6">Looks like you haven't added any products yet</p>
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-2xl md:text-3xl font-bold text-surface-900 dark:text-white mb-8">Shopping Cart ({cart.totalQuantity} items)</h1>
