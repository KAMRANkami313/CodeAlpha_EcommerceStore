  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] grid grid-cols-1 lg:grid-cols-2 bg-white dark:bg-surface-950">
      ...
      >
        ...
        <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] rounded-full bg-violet-500/30 blur-3xl" />
        <div className="absolute bottom-[-15%] right-[-10%] w-[55%] h-[55%] rounded-full bg-primary-400/30 blur-3xl" />
        <div className="absolute top-[40%] left-[30%] w-[30%] h-[30%] rounded-full bg-fuchsia-400/20 blur-3xl" />
        ...
        <div className="relative z-10 space-y-8">
          ...
          <motion.div
            ...
            className="relative p-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20"
          >
        ...
        >
          {[
            ...
            <div
              key={label}
              className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/10 backdrop-blur border border-white/10"
            >
      ...
      >
        <div className="w-full max-w-md">
          {/* Mobile logo (hidden on desktop where brand panel shows it) */}
